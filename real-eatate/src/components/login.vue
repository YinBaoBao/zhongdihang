<template>
  <div class="login">
    <div class="nav">
      <img class="imgs" src="./login.png" alt="login">
      <span class="title">苏州不动产数据集成服务管理后台</span>
    </div>
    <div class="content">
      <div class="title">
...
<style lang="stylus" rel="stylesheet/stylus">
  .login
    width: 100%
    height: 100%
    background: url("../assets/image/loginbg.png") 0 0 no-repeat
    ...
    .content
      ...
      margin-top: -180px
      padding: 0 40px
      background: url("../assets/image/login.png") 0 0 no-repeat
      background-size: 100% 100%
      border-radius: 5px
      text-align: center
      .title
      ...
      .user_ipt
        .el-input__inner
          background: url('../assets/image/loginuser.png') 16px 6px no-repeat
