...
import com.zhongdihang.bankdispatch.modular.service.form.AuthenticationForm;
...
public class LoginController {
    ...
    public ResultModel createAuthenticationToken(@RequestParam  String userName, @RequestParam  String password
