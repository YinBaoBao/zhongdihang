<template>
  <div class="swdycx">
    <div class="header">
      ...
      <div class="content">
        ...
        <div class="time">
          ...
          <el-button @click="_seartch" class="btn_1" style="padding: 8px 30px;margin-right: 15px;margin-left: 50px;">
            查询
          </el-button>
    ...
    <div class="cf_table">
      <el-table id='_tablecontent' ref="sort_table" :data="tableData" border height="550" v-loading="tableloding" element-loading-text="拼命加载中..."
                @sort-change="_sortchange"  style="width: 100%">
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      ...
      freshData() {
        this.$http.post(this.$store.state.Host + '/bankSearch/getDYDJ', {
          jkzh: 200,
          district: this.radio,
          ...
          if (response.code === 200) {
            ...
            for (var i = 0; i < data.length; i++) {
              let json = {
                ...
                starttime: data[i].zwlxqssj,
                endtime: data[i].zwlxjssj,
                dyr: data[i].dyr,
                dyqr: data[i].dyqr,
                dyfs: data[i].dyfsmc,
                address: data[i].zl,
                bdbzqs: data[i].bdbzzqse,
